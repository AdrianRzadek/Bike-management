        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Kolor = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    RowerType = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    KlienciKlientId = table.Column<int>(type: "int", nullable: false),
                    WypożyczeniaWypożyczenieId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_KlientWypożyczenie", x => new { x.KlienciKlientId, x.WypożyczeniaWypożyczenieId });
                    table.ForeignKey(
                        name: "FK_KlientWypożyczenie_Klient_KlienciKlientId",
                        column: x => x.KlienciKlientId,
